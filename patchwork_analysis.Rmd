...
```{r}
# Goal: replicate [coauthor's] results with < 1000 LOC
...
# evaluated_patch - Y for looked at patch, N for did not

# in 4 participant-tasks, they did not evaluate the patch 
full_df_had_patch
applied_unchanged_model = glmer(fix_site_same ~ condition + (1 | PID) + (1 | bug),
                              data = full_df_had_patch,
                              family = binomial)
