...
gaze_valid_df = gaze_valid_df[!(gaze_valid_df$PID == 1 & gaze_valid_df$task_no == 1), ]
...
tapply(professional_YOE, full_df_had_patch$accurate_about_patch_correctness, median)
